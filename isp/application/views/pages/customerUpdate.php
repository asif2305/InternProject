           ...
           <?php echo form_open($action); ?>	
            ...
            <div class="clearfix">
                ...
                <div class="form-input">
                 <td><input type="radio" name="gender" value="Male" <?php echo (isset($customer['gender']) && $customer['gender']=='Male')?'checked':'';?>/> Male
                    <input type="radio" name="gender" value="Female" <?php echo (isset($customer['gender']) && $customer['gender']=='Female')?'checked':'';?>/> Female
                 </td>
                </div>
            ...
            <div class="clearfix">
                ...
                <div class="form-input"><input type="text" id="form-email" name="email" class="text" value="<?php echo (isset($customer['email']))?$customer['email']:''; ?>">
                </div>
            ...
            <div class="clearfix">
                ...
                <div class="form-input"><input type="text" id="form-mac" name="mac" class="text" value="<?php echo (isset($customer['mac']))?$customer['mac']:''; ?>" >
                </div>
